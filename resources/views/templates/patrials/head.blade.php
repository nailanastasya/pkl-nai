    ...
    <link rel="stylesheet" href="{{asset('assets/assets/vendor/libs/apex-charts/apexcharts.js')}}" />

    {{-- <!-- Bootstrap CSS -->
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">

<!-- Bootstrap JS (opsional, kalau butuh komponen interaktif) -->
...
<style>
  :root {
    --bs-danger: #f04349; /* ganti danger jadi warna custom */
  }
</style>
    <!-- Helpers -->
